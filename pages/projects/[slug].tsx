...
import { getPost, getPosts, serialize, deserialize, SerializedPostMetadata, Post, projectsFolder } from "../../services/posts";
...
const Post: NextPage<BlogProps> = ({ post }: { post: SerializedPostMetadata & Pick<Post, 'content'> }) => (
    <PageRoot>
        ...
        <div className={styles["blog-root"]}>
            <PostContents metadata={deserialize(post)} content={post.content} contentType={"project"} />
        </div>
    </PageRoot>
);
